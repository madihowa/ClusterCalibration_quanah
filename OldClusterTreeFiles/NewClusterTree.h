...
// Wed Jul  7 19:14:54 2021 by ROOT version 6.14/04
// from TTree ClusterTree/ClusterTree
// found on file: topo-cluster.pool.root
//////////////////////////////////////////////////////////

#ifndef NewClusterTree_h
#define NewClusterTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   NewClusterTree(TTree *tree=0);
   virtual ~NewClusterTree();
...
#ifdef NewClusterTree_cxx
NewClusterTree::NewClusterTree(TTree *tree) : fChain(0) 
{
...
NewClusterTree::~NewClusterTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NewClusterTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NewClusterTree::LoadTree(Long64_t entry)
{
...
void NewClusterTree::Init(TTree *tree)
{
...
void NewClusterTree::Show(Long64_t entry)
{
...
Int_t NewClusterTree::Cut(Long64_t entry)
{
...
#endif // #ifdef NewClusterTree_cxx
